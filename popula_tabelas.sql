...
INSERT INTO Pessoa(id,nome,tel,id_cidade) VALUES (101,"Milano","0082-3246",2),(102,"Gabriel","3382-8946",2),(103,"Andre","0082-5556",2), (104,"Thales","0082-8334",2),(105,"Beatriz","2222-8946",2);
...
## Tabela Escola (6 escolas) - 2 em cidades iguals e as outras 4 diferentes
...
INSERT INTO Escola(id,nome,id_cidade,id_diretor) VALUES (6,"Universidade Federal de Minas Gerais",2,7);

## Turma (12 turmas) (Todas as escolas possuem pelo menos 1 turma)

INSERT INTO Turma(id,nome,id_escola) VALUES (1,"A1",3),(2,"A1",2),(3,"A1",4),(4,"A1",5),(5,"A1",1),(6,"A2",1),(7,"A2",3),(8,"A3",3),(9,"A4",3),(10,"A5",3);
INSERT INTO Turma(id,nome,id_escola) VALUES (11,"E1",6),(12,"E2",6);

## Tabela Aluno (85 alunos) (21-105 ID PESSOA)
...
INSERT INTO Aluno(id,matricula,data_nasc,id_turma) VALUES (101,9780002319,"23/02/95",11),(102,9780102319,"23/02/95",11),(103,9780002319,"23/02/95",12),(104,9780005319,"23/02/95",12), (105,9780002312,"23/02/95",11);
